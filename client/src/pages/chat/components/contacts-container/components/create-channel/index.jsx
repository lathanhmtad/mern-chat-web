      ...
      <DialogContent className='bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col'>
        ...
        <div>
          <Input
            ...
            placeholder='Channel name' className='rounded-lg p-6 bg-[#2c2e3b] border-none' />
        </div>
        <div>
          <MultipleSelector
        ...
        <div>
          <Button
            ...
            className='w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300'>Create Channel</Button>
        </div>
      </DialogContent>
    </Dialog>
