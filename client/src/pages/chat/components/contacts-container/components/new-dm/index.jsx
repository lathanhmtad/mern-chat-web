  ...
  return <>
    ...
    <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
      <DialogContent className='bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col'>
                ...
                searchedContacts.map(contact =>
                  <div onClick={() => selectNewContact(contact)} key={contact._id} className='flex gap-3 items-center cursor-pointer'>
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className='text-sx'>{contact.email}</span>
                    </div>
                  </div>
                )
              }
        ...
        {
          searchedContacts.length <= 0 && <div className='flex-1 md:flex flex-col justify-center items-center duration-1000 translate-all'>
            <Lottie
          ...
          items-center mt-5 md:mt-0 lg:text-2xl text-xl transition-all duration-300 text-center'>
