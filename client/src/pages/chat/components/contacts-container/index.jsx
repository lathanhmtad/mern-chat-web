...
import { GET_DM_CONTACT_ROUTE, GET_USER_CHANNELS_ROUTE } from '@/utils/constants'
...
const ContactsContainer = () => {
  ...
  return (
    <div className="w-full relative md:w-[35vw] lg:w-[30vw] 
    xl:w[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b]">
      <div className='pt-3'>
        <Logo />
      </div>
      <div className='my-5'>
